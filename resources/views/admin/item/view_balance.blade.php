...
<div class="col-lg-8 pinpin">
  <div class="card lobicard lobicard-custom-control"  data-sortable="true">
    ...
    <?php $count = 1; $count1=1; $sum=0; $sum1=0; ?>
   ...
   <tbody>
    @if($stockData)
    @foreach($stockData as $items)
    <tr>
       <td><?php echo $count ?></td>
       <td>{{ $items->name }}</td>
       <td>{{ number_format($items->qty, 2) }}</td>
   </tr>
   <?php $count++; $sum = $sum + $items->qty ?>
   @endforeach
   @endif
...
<div class="col-lg-12 pinpin">
  <div class="card lobicard lobicard-custom-control"  data-sortable="true">
   ...
   <?php $count1++; $sum1 = $sum1 + $dsr_items->qty ?>
   @endforeach
   @endif
...
<div class="col-lg-12 pinpin">
 <div class="table-responsive">
    <table class="table">
       <tr class="back_table_color">
        <td colspan="2"><b>Grand Quantity Total</b></td>
        <td colspan="2" style="text-align:right;font-weight:bold">{{ number_format($sum+$sum1,2) }}</td>
    </tr>
</table>
</div>
</div>
