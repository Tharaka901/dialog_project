...
public function MobileGetBankingSumery(Request $request){
    ...
    ->select('bankings.id','banks.bank_name','bank_ref_no','bank_amount','sum_id','bankings.dsr_id')
    ->where('pending_sum.date', '=', $request->get('date'))
    ->where('pending_sum.dsr_id', '=', $request->get('dsr_id'))
...
public function MobileGetDirectBankingSumery(Request $request){
    ...
    ->select('directbankings.id','direct_bank_customer_name','banks.bank_name','direct_bank_ref_no','direct_bank_amount','sum_id','directbankings.dsr_id')
    ->where('pending_sum.date', '=', $request->get('date'))
    ->where('pending_sum.dsr_id', '=', $request->get('dsr_id'))
