    ...
    public function MobileDsrCreditcollections(Request $request)
    {
        ...
        foreach ($creditcollections as $creditcol) {
            ...
            if (count($existing_creditcol_customer) == 0) {
                ...
                DB::update("update credit_collections set credit_collection_amount = credit_collection_amount + ? where id = ?",[$creditcol["ccAmount"], $creditcollection->id]);
            } else {
                ...
                DB::update("update credit_collections set credit_collection_amount = credit_collection_amount + ? where id = ?",[$cc["ccAmount"], $customer->id]);
            }
        }
